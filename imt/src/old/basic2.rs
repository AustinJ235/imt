...
pub fn basic_render(
    ...
    let stencil_pipeline = GraphicsPipeline::start()
        ...
        .color_blend_state(ColorBlendState::new(1).blend_additive().color_write_mask(ColorComponents { r: true, g: true, b: true, a: false }))
    ...
    let stencil_image = ImtImageView::from_attachment(
    ...
    let stencil_framebuffer = Framebuffer::new(
        ...
        FramebufferCreateInfo {
            attachments: vec![stencil_image.clone()],
            ..Default::default()
        },
    )
    .unwrap();
...
mod stencil_fs {
    vulkano_shaders::shader! {
        ...
        src: "
			...
			void main() {
				f_color = vec4(1.0 / 255.0, 1.0 / 255.0, 1.0 / 255.0, 1.0);
			}
		"
    }
}
